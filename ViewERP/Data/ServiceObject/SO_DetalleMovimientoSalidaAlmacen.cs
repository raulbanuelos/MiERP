...
namespace Data.ServiceObject
{
	public class SO_DetalleMovimientoSalidaAlmacen
	{
		...
		private string SP_ERP_GET_SALIDAS_ALMACEN_POR_WEEK_DETALLE = "SP_ERP_GET_SALIDAS_ALMACEN_POR_WEEK_DETALLE";
		...
		public DataSet GetSalidasPorWeekDetalle(int idCompania, int idSemana)
        {
            try
            {
				DataSet datos = null;
				...
				datos = conexion.EjecutarStoredProcedure(SP_ERP_GET_SALIDAS_ALMACEN_POR_WEEK_DETALLE, parametros);
